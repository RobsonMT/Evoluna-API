...
export class populateDB1656460449880 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`INSERT INTO "professionals" ("name", "email", "contact") VALUES ('Anna Campbeli', 'anna@mail.com', '(35) 99994-7059'), ('Matheus Marques', 'matheus@mail.com', '(44) 98524-12569'), ('Ingrid Souza', 'ingrid@mail.com', '(21) 91394-6659')`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DELETE FROM "professionals" WHERE "name" IN ('Anna Campbeli', 'Matheus Marques', 'Ingrid Souza')`)
